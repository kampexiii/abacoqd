...
/**
 * Cuerpo del widget de accesibilidad (Sheet/Radix Dialog). Se carga en DIFERIDO
 * desde `AccessibilityFab` en la primera apertura, para mantener sus toggles,
 * iconos y el hook `useAccessibility` fuera del bundle inicial. Las preferencias
 * persistidas ya se aplican al arrancar vía `initializeAccessibility()` (app.tsx),
 * así que diferir este panel no afecta a lo que se ve al cargar.
 *
 * Debe renderizarse dentro de un `<Sheet>` (el contexto de Radix lo aporta
 * `AccessibilityFab`).
 */
