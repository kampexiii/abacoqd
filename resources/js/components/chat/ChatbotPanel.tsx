...
/**
 * Cuerpo del chatbot (Sheet/Radix Dialog). Se carga en DIFERIDO desde
 * `ChatbotFab` en la primera apertura, para mantener su lógica de FAQs y sus
 * iconos fuera del bundle inicial. Debe renderizarse dentro de un `<Sheet>`: el
 * contexto de Radix (estado open/close, foco) lo aporta `ChatbotFab`.
 *
