...
export default function BookingSlotForm({ mode, slot, defaultDate }: BookingSlotFormProps) {
        ...
        <form onSubmit={submit} className="grid max-w-2xl gap-6">
            <div className="rounded-2xl border border-qd-mist bg-qd-white p-6 dark:border-qd-white/10 dark:bg-qd-surface">
                <p className="mb-4 text-xs text-qd-text-medium dark:text-qd-white/40">
                    Lo habitual es generar disponibilidad desde la agenda. Usa este formulario solo para una franja puntual; el día se crea
                    automáticamente.
                </p>
                <div className="flex flex-col gap-4">
                    ...
                    {data.admin_blocked && (
                        <Field label="Motivo del bloqueo (interno)" error={errors.block_reason}>
