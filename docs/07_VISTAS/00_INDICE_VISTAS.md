...
| Doc | Vista | Rutas |
|---|---|---|
| `PUBLIC_01_HOME_LANDING.md` | Home / Landing: Hero, Metodología, Servicios, Colaboraciones, Blog, CTA final, Footer | `/` |
| `PUBLIC_02_METODOLOGIA_PROCESO.md` | Metodología / Proceso: sección landing + página ampliada | `/metodologia` |
| `PUBLIC_03_SERVICIOS.md` | Servicios: listado, detalle preparado y sección landing | `/servicios` · `/servicios/{slug}` |
| `PUBLIC_04_PROYECTOS.md` | Proyectos: listado, detalle de proyecto y sección de landing (Colaboraciones) | `/proyectos` · `/proyectos/{slug}` |
| `PUBLIC_05_BLOG.md` | Blog: índice, post y destacados de landing | `/blog` · `/blog/{slug}` |
| `PUBLIC_06_CONTACTO_RESERVA.md` | Contacto + Reserva con sistema propio de citas y fallback a contacto | `/contacto` · `/reserva` |
...
| `PUBLIC_10_QUIENES_SOMOS.md` | Quiénes somos: origen, equipo/estudio y contexto corporativo | `/quienes-somos` |
...
| Doc | Ámbito |
|---|---|
| `ADMIN_01_LAYOUT_DASHBOARD_PATRONES.md` | Layout del panel, dashboard, patrones CRUD, estados, tablas, formularios, auditoría y accesibilidad del admin |
...
- El lanzamiento inicial es **Spanish-first**. Una versión EN solo se documentará como activa cuando exista de forma completa con rutas y SEO reales.
