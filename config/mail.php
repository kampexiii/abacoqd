...
return [
    ...
    */
    ...
    'mailers' => [
        ...
        'smtp' => [
            ...
            'timeout' => null,
            'local_domain' => env('MAIL_EHLO_DOMAIN', parse_url((string) env('APP_URL', 'https://abacoqd.com'), PHP_URL_HOST)),
        ],
    ...
    */
    ...
    'from' => [
        'address' => env('MAIL_FROM_ADDRESS', 'info@abacoqd.com'),
        'name' => env('MAIL_FROM_NAME', 'AbacoQD'),
    ],
